            ...
            <AppBar position="static">
                <Toolbar>
                    ...
                    <NavLink style={{ textDecoration: 'none' }} to="/appointment">
                        <Button variant="text" style={{ color: 'white' }}>Appointment</Button>
                    </NavLink>
                    {
                        user?.email
                            ? <Box>
                            ...
                            : <NavLink style={{ textDecoration: 'none' }} to="/login"><Button variant="text" style={{ color: 'white' }}>Login</Button></NavLink>
                    }
                </Toolbar>
            </AppBar>
        </Box>
